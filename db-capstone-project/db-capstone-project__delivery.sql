...
--
-- Table structure for table `_delivery`
--

DROP TABLE IF EXISTS `_delivery`;
...
--
-- Dumping data for table `_delivery`
--

LOCK TABLES `_delivery` WRITE;
/*!40000 ALTER TABLE `_delivery` DISABLE KEYS */;
/*!40000 ALTER TABLE `_delivery` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-11-23  8:38:06
